                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div class="review-poster-video-avatar avatar mb-3">
                                        ...
                                        <div class="avatar-dimension">
                                            ...
                                            <p class="mb-0">Định dạng: <strong><?= !empty($config['website']['video']['poster']['extension']) ? $config['website']['video']['poster']['extension'] : '.jpg|.png' ?></strong></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="video-config">
                                        <span class="d-inline-block me-2">Định dạng: <strong><?= !empty($config['website']['video']['extension']) ? implode(" | ", $config['website']['video']['extension']) : 'mp4' ?></strong></span>
                                        <span class="d-inline-block">Tối đa: <strong><?= !empty($config['website']['video']['allow-size']) ? $config['website']['video']['allow-size'] : '100Mb' ?></strong></span>
                                    </div>
                                </div>
                            <?php } */ ?>
                        </div>
