<section class="fitnado-hero">
    <div class="fitnado-wrap fitnado-heroGrid">
        <div class="fitnado-hero-left">
            ...
            <div class="fitnado-hero-title">TÌM ĐÚNG ĐỒ TẬP<br><span>KHỎI MUA NHẦM.</span></div>
            <p>
        ...
        <div class="fitnado-visual">
            <?php if (!empty($slider[0]['photo'])) { ?>
                <a href="<?= (!empty($slider[0]['link'])) ? $slider[0]['link'] : 'san-pham' ?>" title="<?= (!empty($slider[0]['name' . $lang])) ? $slider[0]['name' . $lang] : 'Khỏe Pro' ?>">
