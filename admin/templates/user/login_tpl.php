...
<div class="login-box">
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg"><?=dangnhaphethong?></p>
            <form enctype="multipart/form-data">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control text-sm" name="username" id="username" placeholder="<?=taikhoan?> *" autocomplete="off">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-append login-input-group-append">
                        <div class="input-group-text">
                    ...
                    <input type="password" class="form-control text-sm" name="password" id="password" placeholder="<?=matkhau?> *" autocomplete="off">
...
<div class="login-copyright text-sm">Powered by <a href="//nina.vn" target="_blank" title="Designed by Nina.vn">Designed by Nina.vn</a></div>